...
internal final class LocalUserRepository: LocalUserRepositoryType {
    ...
    @MainActor func setSession(_ session: AuthDataResult, userDTO: UserDTO) async throws {
        let userEntity = UserEntity(
            ...
            targetStreak: userDTO.targetStreak,
            lastTargetUpdated: userDTO.lastTargetUpdated,
            isStreakComplete: userDTO.isStreakComplete,
    ...
    @MainActor func getSession() async throws -> UserModel? {
        ...
        let userModel = UserModel(
            ...
            targetStreak: userEntity.targetStreak,
            lastTargetUpdated: userEntity.lastTargetUpdated,
            isStreakComplete: userEntity.isStreakComplete,
