...
final class LocalPhraseRepository: LocalPhraseRepositoryType {
    ...
    @MainActor func createPhrase(_ phrase: PhraseCardModel) throws {
        let entity = PhraseCardEntity(id: phrase.id, topicID: phrase.topicID, vocabulary: phrase.vocabulary, phrase: phrase.phrase, translation: phrase.translation, vocabularyTranslation: phrase.vocabularyTranslation ?? "", isReviewPhase: phrase.isReviewPhase, levelNumber: phrase.levelNumber, prevLevel: "0", nextLevel: "1", lastReviewedDate: phrase.lastReviewedDate, nextReviewDate: phrase.nextReviewDate)
